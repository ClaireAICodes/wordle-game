// Wordle Solution Words - Official 2,315 words from wordle-words
// Indexed 1-2315 for shareable puzzle IDs
const SOLUTIONS = [
    ...
    "dicey", "digit", "dilly", "diner", "dingo", "dingy", "diode", "dirge", "dirty", "disco",
    ...
    "usage", "usher", "using", "usual", "usurp", "utile", "utmost", "vague", "valet", "valid",
    "valor", "value", "valve", "vapor", "vault", "vaunt", "vegan", "venom", "venue", "verge",
    "verse", "verso", "verve", "vicar", "video", "vigil", "vigor", "villa", "vinyl", "viola",
    "viper", "viral", "virus", "visit", "visor", "vital", "vivid", "vixen", "vocal", "vodka",
    "vogue", "voice", "voila", "vomit", "voter", "vouch", "vowel", "vying", "wacky", "wafer",
    "wager", "wagon", "waist", "waits", "waive", "waltz", "warty", "waste", "watch", "water",
